...
const AgreementForm = forwardRef(({ onNext, onBack }, ref) => {
        ...
        <>
            <Grid sx={{ display: "flex", flexDirection: "column", gap: "0.8rem", background: "#fff", margin: "0 12px", padding: "1rem" }}>
                <Typography variant='p' sx={{ textAlign: "justify" }}>
                    • {t("By clicking on the checkbox, you agree that the information you have provided is accurate to the best of your knowledge. If any information is found to be false, your application may be rejected, and legal action may be taken against you.")}
                </Typography>
                <Typography variant='p' sx={{ textAlign: "justify" }}>
                    • {t("You are responsible for verifying all the details mentioned in the application form before submitting it. Once you have verified the details, you must print the form and sign it.")}
                </Typography>
                <Typography variant='p' sx={{ textAlign: "justify" }}>
                    • {t("The signed copy of the application form must be uploaded in the next process. Failure to upload the signed copy may result in the rejection of your application.")}
                </Typography>
            </Grid>
            <Grid sx={{ padding: "1rem" }}>
                ...
                {checked && (
                    <>
                        ...
                        <FormControlLabel
                            sx={{ display: 'flex', flexDirection: "row-reverse", justifyContent: "start", paddingLeft: "12px", width: "fit-content"}}
