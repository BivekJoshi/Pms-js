  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <Box className='flex justify-center' paddingBottom='32px'>
          <img src={Logo} alt='Logo' className='xs:w-3/5 sm:w-3/4' />
        </Box>
        <Typography
          color='white'
        ...
        <Typography color='white' fontSize={{ xs: '.8rem', md: '1rem' }}>
          “Stay ahead of the curve with us”
        </Typography>
      </Box>

      <Box
        className='relative flex flex-col truncate items-center justify-center flex-wrap'
        sx={{
          background: '#fdf8fd',
          borderRadius: { xs: '50px 50px 0 0', md: '50px 0 0 50px;' },
        }}
      >
        <span className='absolute sm:bottom-36 left-0 xs:bottom-9'>
          <svg
            width='48'
            height='102'
            viewBox='0 0 48 102'
        ...
        <span className='absolute left-0 top-28'>
          <svg
            width='45'
            height='83'
            viewBox='0 0 45 83'
        ...
        <span className='absolute right-0 bottom-0 z'>
          <svg
            width='40'
            height='128'
            viewBox='0 0 40 128'
        ...
        <img
          src={Bear}
          alt='bear--.png'
          className='md:top-20 xs:top-5 absolute right-40'
        />
        <img src={Curved} alt='RightPick' className=' absolute w-screen' />
