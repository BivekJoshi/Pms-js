...
import { Collapse, Drawer, Grid, Typography } from "@mui/material";
            ...
            >
              <Tab
                label={
                  <Grid className="profileIcon">
                    ...
                    <Typography variant="h7">{t("UPDATE PROFILE")}</Typography>
                  </Grid>
                }
                value="1"
                style={{
              ...
              <Tab
                ...
                style={{
                  ...
                  padding: ".2",
                  backgroundColor:
                    value === "2" ? theme.palette.primary.main : "transparent",
                  borderRadius: ".5rem",
                }}
              />
              <Tab
                ...
                style={{
                  ...
                  padding: ".2",
                  backgroundColor:
                    value === "3" ? theme.palette.primary.main : "transparent",
                  borderRadius: ".5rem",
                }}
              />
              <Tab
                label={
                  <Grid className="profileIcon">
                    ...
                    <Typography variant="h7">{t("CHANGE PASSWORD")}</Typography>
                  </Grid>
                }
                value="4"
                style={{
                  ...
                  padding: ".2",
                  backgroundColor:
                    value === "4" ? theme.palette.primary.main : "transparent",
                  borderRadius: ".5rem",
                }}
              />
            </Tabs>
            ...
            >
              <Tab
                ...
                style={{
                  ...
                  alignItems: "flex-start",
                  backgroundColor:
                    value === "5" ? theme.palette.primary.main : "transparent",
                  borderRadius: ".5rem",
                }}
              />
              <Tab
                ...
                style={{
                  ...
                  padding: ".2",
                  backgroundColor:
                    value === "6" ? theme.palette.primary.main : "transparent",
                  borderRadius: ".5rem",
                }}
              />
              <Tab
                ...
                style={{
                  ...
                  padding: ".2",
                  backgroundColor:
                    value === "7" ? theme.palette.primary.main : "transparent",
                  borderRadius: ".5rem",
                }}
              />
              <Tab
                label={
                  <Grid className="profileIcon">
                    ...
                    <Typography variant="h7">{t("RECEIPT/PAYMENT")}</Typography>
                  </Grid>
                }
                value="8"
                style={{
                  ...
                  padding: ".2",
                  backgroundColor:
                    value === "8" ? theme.palette.primary.main : "transparent",
                  borderRadius: ".5rem",
                }}
              />
            </Tabs>
            ...
            >
              <Tab
                ...
                style={{
                  ...
                  padding: ".2",
                  backgroundColor:
                    value === "9" ? theme.palette.primary.main : "transparent",
                  borderRadius: ".5rem",
                }}
              />
              <Tab
                label={
                  <Grid className="profileIcon">
                    ...
                    <Typography variant="h7">{t("PRIVACY POLICY")}</Typography>
                  </Grid>
                }
                value="10"
                style={{
                  ...
                  padding: ".2",
                  backgroundColor:
                    value === "10" ? theme.palette.primary.main : "transparent",
                  borderRadius: ".5rem",
                }}
              />
            </Tabs>
