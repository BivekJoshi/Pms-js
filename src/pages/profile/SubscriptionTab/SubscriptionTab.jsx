...
const data = [
  {
    list: "Watchlist up to 20 scripts",
  },
  {
    list: "No more than 2 watchlist",
  },
  {
    list: "No more than 2 accounts (Portfolio)",
  },
  {
    list: "Top 4 list of best and worst performer",
  },
  {
    list: "Watch list up to 20",
  },
];
          ...
          <defs>
            ...
            >
              <stop
                ...
                stop-opacity="0.9"
              />
              <stop offset="0.510157" stop-color="#643C03" stop-opacity="0.8" />
              <stop offset="0.936486" stop-color="#643C03" stop-opacity="0.7" />
              <stop offset="0.994355" stop-color="#643C03" stop-opacity="0.8" />
            </linearGradient>
          </defs>
        </svg>
      </div>
