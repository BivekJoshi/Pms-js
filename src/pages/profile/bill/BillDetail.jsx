...
const BillDetail = ({rowData}) => {
    console.log(rowData?.billNo,"rowData hai ma");
    ...
    <div>
      ...
      >
        ...
        <Box>
          ...
          <Typography variant="h6">{tableData?.totalSebonCommission}</Typography>
        </Box>
        <Box>
        ...
        <Box>
          ...
          <Typography variant="h6">{tableData?.totalStockCommission}</Typography>
        </Box>
        <Box>
